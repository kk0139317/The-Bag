...
const ProductDetail = (context) => {
  ...
  // Assuming we're fetching the product ID from the URL
  // For simplicity, let's use the first product
  const { id } = context.params;
  // const product = products[0]; // Use dynamic fetching based on URL in a real app
  ...
  // Initialize states with the first available options
  useState(() => {
